...
uint8_t Battery::level(uint32_t voltage)
{
	...
	else
	{
		...
		else if (currentMillis - OldMillis > 15000) {													// toutes les 10 sec, on abaisse ou remonte le % si jamais la tension à varié. Basé sur le fait qu'on ne peut pas cramer plus d'1% de batt en 10 sec.
