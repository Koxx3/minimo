...
uint8_t tft_type = 0;
TOGGLE(tft_type, tft_type_LIST,"  Type : ",doNothing,noEvent,noStyle //
...
uint8_t tft_min_value = 1;
uint8_t tft_max_value = 5;
...
uint8_t tft_b1_short_press_action = 0;
TOGGLE(tft_b1_short_press_action, tft_b1_short_press_action_LIST,"  B1 short press action : ",doNothing,noEvent,noStyle //
...
uint8_t tft_b1_long_press_action = 0;
TOGGLE(tft_b1_long_press_action, tft_b1_long_press_action_LIST,"  B1 long press action : ",doNothing,noEvent,noStyle //
    ,VALUE("None", 0 ,doNothing,noEvent) //
...
uint8_t tft_b2_short_press_action = 0;
TOGGLE(tft_b2_short_press_action, tft_b2_short_press_action_LIST,"  B2 short press action : ",doNothing,noEvent,noStyle //
    ,VALUE("None", 0 ,doNothing,noEvent) //
...
MENU(SUBMENU_Electric_brake,"  Electric brake",doNothing,noEvent,noStyle //
    ...
    ,SUBMENU(tft_type_LIST) //
    ,FIELD(tft_min_value,"  Min value : ","", 0, 5, 1, 1, doNothing,noEvent,wrapStyle) //
    ,FIELD(tft_max_value,"  Max value : ","", 0, 5, 1, 1, doNothing,noEvent,wrapStyle) //
...
MENU(SUBMENU_Escooter_buttons,"  Escooter buttons",doNothing,noEvent,noStyle //
    ,SUBMENU(tft_b1_short_press_action_LIST) //
    ,SUBMENU(tft_b1_long_press_action_LIST) //
    ,SUBMENU(tft_b2_short_press_action_LIST) //
...
void settings_menu_init_from_settings() {
    ...
    tft_type = app_settings->get_type();
    tft_min_value = app_settings->get_min_value();
    tft_max_value = app_settings->get_max_value();
    ...
    tft_b1_short_press_action = app_settings->get_b1_short_press_action();
    tft_b1_long_press_action = app_settings->get_b1_long_press_action();
    tft_b2_short_press_action = app_settings->get_b2_short_press_action();
...
void settings_menu_save_to_settings() {
    ...
    app_settings->set_type(tft_type);
    app_settings->set_min_value(tft_min_value);
    app_settings->set_max_value(tft_max_value);
    ...
    app_settings->set_b1_short_press_action(tft_b1_short_press_action);
    app_settings->set_b1_long_press_action(tft_b1_long_press_action);
    app_settings->set_b2_short_press_action(tft_b2_short_press_action);
