...
void settings_menu_init_from_settings() {
    ...
    tft_Ebrake_max_power_value = app_settings->get_Ebrake_max_power_value();
    tft_Ebrake_time_between_mode_shift = app_settings->get_Ebrake_time_between_mode_shift();
    tft_Ebrake_disabled_on_high_battery_voltage = app_settings->get_Ebrake_disabled_on_high_battery_voltage();
    tft_Ebrake_disabled_percent_limit = app_settings->get_Ebrake_disabled_percent_limit();
    tft_Throttle_regeneration = app_settings->get_Throttle_regeneration();
    tft_Throttle_input_min_voltage = app_settings->get_Throttle_input_min_voltage();
    tft_Throttle_input_max_voltage = app_settings->get_Throttle_input_max_voltage();
    tft_Throttle_output_min_voltage = app_settings->get_Throttle_output_min_voltage();
    tft_Throttle_output_max_voltage = app_settings->get_Throttle_output_max_voltage();
    tft_Throttle_output_curve = app_settings->get_Throttle_output_curve();
...
void settings_menu_save_to_settings() {
    ...
    app_settings->set_Ebrake_max_power_value(tft_Ebrake_max_power_value);
    app_settings->set_Ebrake_time_between_mode_shift(tft_Ebrake_time_between_mode_shift);
    app_settings->set_Ebrake_disabled_on_high_battery_voltage(tft_Ebrake_disabled_on_high_battery_voltage);
    app_settings->set_Ebrake_disabled_percent_limit(tft_Ebrake_disabled_percent_limit);
    app_settings->set_Throttle_regeneration(tft_Throttle_regeneration);
    app_settings->set_Throttle_input_min_voltage(tft_Throttle_input_min_voltage);
    app_settings->set_Throttle_input_max_voltage(tft_Throttle_input_max_voltage);
    app_settings->set_Throttle_output_min_voltage(tft_Throttle_output_min_voltage);
    app_settings->set_Throttle_output_max_voltage(tft_Throttle_output_max_voltage);
    app_settings->set_Throttle_output_curve(tft_Throttle_output_curve);
