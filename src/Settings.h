...
public:
    ...
    void set_Display_splash_screen (uint8_t value);
    uint8_t get_Display_splash_screen();
    void display_Display_splash_screen();
    void save_Display_splash_screen(uint8_t value);
